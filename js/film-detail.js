  ...
  .then((comments) => {
    ...
    comments.forEach((comment) => {
      ...
      for (let i = 0; i < fullStars; i++) {
        starsHTML += `<img src="assets/icons/full-star.png" alt="full star" class="star">`;
      }
      if (halfStar) {
        starsHTML += `<img src="assets/icons/half-star.png" alt="half star" class="star">`;
      }
      for (let i = 0; i < emptyStars; i++) {
        starsHTML += `<img src="assets/icons/empty-star.png" alt="empty star" class="star">`;
      }
      starsHTML += `</span>`;
    ...
    .then((data) => {
      ...
      if (film) {
        ...
        for (let i = 0; i < filmFullStar; i++) {
          filmStarsHTML += `<img src="assets/icons/full-star.png" alt="full star" class="film-star">`;
        }
        if (filmHalfStar) {
          filmStarsHTML += `<img src="assets/icons/half-star.png" alt="half star" class="film-star">`;
        }
        for (let i = 0; i < filmEmptyStar; i++) {
          filmStarsHTML += `<img src="assets/icons/empty-star.png" alt="empty star" class="film-star">`;
        }
        filmStarsHTML += `</span>`;
